    ...
    <form class="layui-form layui-form-pane" action="" lay-filter="staffForm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="width: 190px">
                <select name="staffSex" id="staffSex" lay-verify="required">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="width: 190px">
                <select name="firmId" id="firmId" lay-verify="required" lay-search>
...
<script>
    ...
    layui.use('form', function () {
        ...
        form.on('submit(formDemo)', function (data) {
            $.ajax({
                url: "${pageContext.request.contextPath}/staff/updateStaff.action",
                type: "post",
                dataType: 'text',
